...
s = SetDefault(s, 'gen.run2d',    0);   % 0 = 3D | 1, 2, 3 = 2D slice along n-th dimension?
...
s = SetDefault(s, 'write.labels',    false(1,2));    % Manual labels in template space [native template]
